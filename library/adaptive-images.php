...
///* CONFIG ----------------------------------------------------------------------------------------------------------- */
//
//$resolutions   = array(1920, 1264, 1024, 768, 480); // the resolution break-points to use (screen widths, in pixels)
//$cache_path    = "wp-content/uploads/adaptive-image-cache"; // where to store the generated re-sized images. Specify from your document root!
