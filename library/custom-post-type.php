...
function custom_post_project() { 
	...
	register_post_type( 'project', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array( 'labels' => array(
				...
				'not_found' =>  __( 'No projects found in the database.', 'bonestheme' ), /* This displays if there are no entries yet */ 
				'not_found_in_trash' => __( 'No projects found in the trash', 'bonestheme' ), /* This displays if there is nothing in the trash */
				'parent_item_colon' => ''
			), /* end of arrays */
			'description' => __( 'Projects for the Blueleaf Portfolio.  Displayed on the portfolio page.', 'bonestheme' ), /* Custom Type Description */
			'public' => true,
